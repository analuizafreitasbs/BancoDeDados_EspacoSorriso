...
def fix_rel_format_correctly(content):
    """Fix the .rel format for Relax compatibility - only data lines get quotes"""
    ...
    for line in lines:
        ...
        if '=' in line and '{' in line:
            ...
            result.append(line)
            continue
        elif ':' in line and not line.startswith('\t'):  # header line - keep as is
            result.append(line)
            continue
...
new_content = fix_rel_format_correctly(content)
